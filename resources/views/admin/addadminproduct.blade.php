...
@endif
						...
						<div class="row gx-3">
							<div class="col-xxl-12">
								<div class="card">
									<div class="card-body">
										<form action="{{route('submitproduct')}}" method="post"   enctype="multipart/form-data" class="row g-3 needs-validation" novalidate  >
                      @csrf
...
<option  value="{{$sc->type_id}}">{{$sc->name}}</option>
@endforeach
                      </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="productcost" id="productcost"  class="form-control">
