          ...
          <div class="search-container me-4 d-xl-block d-lg-none">
						...
						<div class="row gx-3">
							<div class="col-xxl-12">
								<div class="card">
									<div class="card-body">
										<form    action="{{route('submittransactionpin')}}"  method="post" class="row g-3 needs-validation" novalidate>
                    @csrf
											<div class="col-md-6">
                      ...
                      @endif
                        ...
                        <input type="text" name="conformtransactionpin" class="form-control" id="exampleInputUsername1" placeholder="Transaction Pin">
