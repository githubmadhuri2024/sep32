		...
		<div class="content-wrapper">
			...
			<div class="row gx-3">
				...
				<div class="col-xl-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-img">
							<img src="{{asset('/uploads/level32.jpg')}}"   class="card-img-top img-fluid" alt="Google Admin" />
						</div>
						<div class="card-body text-center">
							
							<h4 class="fw-light mb-4">Swing Chair</h4>
				...
				<div class="col-lg-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-body">
							...
							<img   src="{{asset('/uploads/level42.jpg')}}"  class="rounded-4 img-fluid mb-4" alt="Google Admin" />
							<h4 class="mb-3">Led Tv </h4>
				...
				<div class="col-lg-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-body text-center">
							...
							<img  src="{{asset('/uploads/level52.jpg')}}"  class="rounded-4 img-fluid mb-4" alt="Google Admin" />
				...
				<div class="col-xl-4 col-sm-12 col-12">
					<div class="card">
						<div class="card-body text-center">
							...
							<img src="{{asset('/uploads/level62.jpg')}}" class="rounded-4 img-fluid mb-4" alt="Google Admin" />
