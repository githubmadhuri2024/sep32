		...
		<div class="content-wrapper">
			...
			<div class="row gx-3">
				<div class="col-xl-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-img">
							<img src="{{asset('/uploads/level11.jpg')}}" class="card-img-top img-fluid" alt="Google Admin" />
						</div>
						<div class="card-body">
							
							<h4 class="fw-light mb-4">Karchief</h4>
				...
				<div class="col-xl-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-img">
							<img src="{{asset('/uploads/level31.jpg')}}"  class="card-img-top img-fluid" alt="Google Admin" />
						</div>
						<div class="card-body text-center">
							
							<h4 class="fw-light mb-4">Ac Dohar</h4>
				...
				<div class="col-xl-4 col-sm-12 col-12">
					<div class="card">
						<div class="card-img">
							<img src="{{asset('/uploads/level41.jpg')}}"  class="card-img-top img-fluid" alt="Google Admin" />
						</div>
						<div class="card-body text-center">
							
							<h4 class="fw-light mb-4">Saree</h4>
				...
				<div class="col-lg-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-body">
							...
							<img   src="{{asset('/uploads/level51.jpg')}}"  class="rounded-4 img-fluid mb-4" alt="Google Admin" />
							<h4 class="mb-3">Saree</h4>
				...
				<div class="col-lg-4 col-sm-6 col-12">
					<div class="card">
						<div class="card-body text-center">
							...
							<img src="{{asset('/uploads/level61.png')}}"  class="rounded-4 img-fluid mb-4" alt="Google Admin" />
